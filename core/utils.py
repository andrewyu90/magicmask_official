...
def disentangle_and_swapping_test_mpie(nets, config, inputs, save_dir):
    ...
    src, tar, src_lm, tar_lm, src_mask, tar_mask, src_name, tar_name = inputs.src, inputs.tar, \
            inputs.src_lm, inputs.tar_lm, inputs.src_mask, inputs.tar_mask, inputs.src_name,  inputs.tar_name,
