...
class Generator(nn.Module):
    ...
    def forward(self, x, lm, s, masks=None): # X is depth image, lm is landmark image, s is source code
        """
        Args:
...
def build_model(args):
    ...
    if args.multi_discriminator:
        ...
        nets = Munch(generator=generator, style_encoder=style_encoder, discriminator=discriminator_img,discriminator2=discriminator_img2)
